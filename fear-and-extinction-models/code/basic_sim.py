...
def make_old_figure(fear_stages_simulations, n_simulations, t1, t2, filename="normal"):
    ...
    if __name__ == '__main__':
        ...
        plt.savefig('fear_stages/avarage_'+filename+'.png', dpi = 200)
        plt.show()
...
def make_figure(fear_stages_simulations, n_simulations, t1, t2, filename="normal"):
    ...
    if __name__ == '__main__':
        ...
        ax.text(175, -350, 'CONDITIONING', fontsize=15)
        ax.text(1100, -350, 'EXTINCTION', fontsize=15)
        ax.text(1900, -350, 'REN.', fontsize=15)
        ...
        ax.set_xlim(50, tsim)
        ax.set_ylim(-0.25, 2.5)       # match your desired frequency range
...
if protocol == 1:
    ...
    make_old_figure(fear_stages_simulations, n_simulations, t1, t2, filename)

# ----------------------------------------------------------------------------
# PTSD Fear Extinction (Protocol 2)
# ARGUMENT 2 is DBS treatments
# ----------------------------------------------------------------------------
# Changes:
...
#       
    ...
    for i in range(len(m_array)):
        if m_array[i] == 1 and m_array[i-1] == 0:
            print(i)
